...
export function AuthModal({ open, onClose, onSuccess }) {
  ...
  function handleOAuth(provider) {
    window.location.href = `${API_BASE}/auth/oauth2/${provider}/login`;
  }
    ...
    >
      <div className="modal">
        ...
        <div className="oauth-buttons">
          <button type="button" className="btn oauth-google" onClick={() => handleOAuth('google')}>
          ...
          <button type="button" className="btn oauth-github" onClick={() => handleOAuth('github')}>
